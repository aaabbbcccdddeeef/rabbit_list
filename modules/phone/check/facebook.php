...
$email=str_replace('@','%40',$_GET['phone']);
// echo "loading...";
function get_datr()
{
...
$ch=curl_init();
 ...
 if(preg_match_all('/(请选择获取密码重置验证码的方式。)/',$output_data,$str))
 {
   ...
   $site="facebook.com";
   $email1=$_GET['phone'];
   echo '[{"from_id":"'.$email1.'","root_id":"registed:'.$site.'","root_label":"registed:'.$site.'","type":"registed","imageurl":"/img/icon/registed.png","title":"该邮箱可能注册 '.$site.',通常意味着邮箱主人使用境外社交媒体","raw_data":"","edge_color":"orange","edge_label":"注册枚举"}]';
 }
 else 
 {
    echo '[{}]';
