...
if($itemdata=='该域名已被注册。')
{
  echo '{"from_id":"'.$domain_name.'","root_id":"'.$domainname.'","root_label":"'.$domainname.'","type":"domain","imageurl":"/img/icon/domain.png","title":"腾讯云页面爬取的结果","raw_data":"","edge_color":"yellow","edge_label":"Tencent Cloud 爬取"},';
break;    
}    
break;            
}
